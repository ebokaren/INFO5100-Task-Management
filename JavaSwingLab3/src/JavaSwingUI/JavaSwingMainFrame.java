 ...
 * @author eboka
 */
public class JavaSwingMainFrame extends javax.swing.JFrame {

    /**
     * Creates new form JavaSwingMainFrame
     */
    public JavaSwingMainFrame() {
        initComponents();
    ...
    private void btnFormActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFormActionPerformed
        ...
        FormPage formPage = new FormPage(bottomPanel);
        bottomPanel.add(formPage);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JavaSwingMainFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JavaSwingMainFrame().setVisible(true);
            }
        });
    }
